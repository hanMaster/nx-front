...
export function proxy(request: NextRequest) {
    ...
    const securityHeaders = {
        ...
        "Content-Security-Policy": [
            ...
            "connect-src 'self' http://localhost:5001 https://102922.selcdn.ru https://mc.yandex.ru https://mc.yandex.com https://*.rutube.ru wss://mc.yandex.ru/solid.ws wss://mc.yandex.com/solid.ws",
