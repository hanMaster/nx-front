...
export default function MastersError({
    error,
    reset,
}: {
    ...
    return (
        <main className="md:container md:mx-auto pt-[85px] text-center p-8">
            <h2 className="title mb-6">Ошибка загрузки мастер-классов</h2>
            <p className="text mb-4">
                Не удалось загрузить список мастер-классов. Попробуйте обновить
                страницу.
            </p>
