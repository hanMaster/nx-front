...
export const metadata: Metadata = {
    title: 'Детский кейтеринг в Находке - меню для праздника с доставкой',
    description: 'Заказать кейтеринг для детского праздника в Находке ⭐ Готовое меню для дня рождения: закуски, горячее, десерты. Доставка в студии и на дом ☎ +7(914)709-38-88',
    alternates: {
        canonical: 'https://igra-em.ru/menu',
    },
    openGraph: {
        title: 'Детский кейтеринг в Находке - заказать меню',
        description: 'Заказать кейтеринг для детского праздника ⭐ Готовое меню: закуски, горячее, десерты. Доставка',
