...
export const metadata: Metadata = {
    title: 'Детский клуб Давай поиграем в Находке - аренда зала, игровая комната',
    description: 'Детский клуб Давай поиграем в Находке ⭐ Аренда игрового зала для праздников. До 14 детей, батут, поролоновая яма, проектор. 7000 руб/час ☎ +7(914)709-38-88',
    alternates: {
        canonical: 'https://igra-em.ru/davai-poigraem',
    },
    openGraph: {
        title: 'Клуб Давай поиграем - детский игровой зал в Находке',
        description: 'Аренда игрового зала для праздников ⭐ До 14 детей, батут, поролоновая яма. 7000 руб/час',
