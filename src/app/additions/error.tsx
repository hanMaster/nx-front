...
export default function AdditionsError({
    error,
    reset,
}: {
    ...
    return (
        <main className="md:container md:mx-auto pt-[85px] text-center p-8">
            <h2 className="title mb-6">Ошибка загрузки дополнений</h2>
            <p className="text mb-4">
                Не удалось загрузить список дополнений к празднику. Попробуйте
                обновить страницу.
            </p>
